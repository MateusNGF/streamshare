        ...
        <>
            ...
            <div className="bg-white/70 backdrop-blur-md p-6 rounded-[32px] border border-white/20 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full hover:-translate-y-1 duration-300">
                <div className="flex items-start justify-between mb-6">
                    ...
                    <Tooltip content="Compartilhar Streaming">
                        <button
                            onClick={() => setIsShareModalOpen(true)}
                            className="p-2 rounded-xl border transition-all flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-400 border-gray-100 hover:text-primary hover:border-primary/20"
                        >
                            <Link size={16} />
                        </button>
                    </Tooltip>
