...
export function ExploreEmptyState({ searchTerm, userPlan = "free" }: ExploreEmptyStateProps) {
    ...
    const ActionButton = !isFreePlan ? (
        <Button
            ...
            className="group relative overflow-hidden flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-bold text-white transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 bg-primary shadow-primary/20 hover:bg-accent"
        >
