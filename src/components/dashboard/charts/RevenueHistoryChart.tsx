...
export function RevenueHistoryChart({ data, currencyCode, onAddStreaming }: RevenueHistoryChartProps) {
    const hasData = data && data.length > 0 && data.some(d => d.receita > 0 || d.novosMembros > 0);
