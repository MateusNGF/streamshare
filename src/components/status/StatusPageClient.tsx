...
const changelogData = [
    {
        ...
        changes: [
            ...
            { category: "Interface", description: "Redesign das etapas de **Configuração de Valores**, oferecendo feedback visual imediato sobre margens de lucro." },
            { category: "Mobile", description: "Ajuste responsivo nos campos de edição de valores, facilitando a gestão financeira via dispositivos móveis." },
