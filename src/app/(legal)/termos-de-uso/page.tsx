            ...
            <div className="container mx-auto px-6 max-w-5xl">
                <article className="space-y-16">
                    ...
                    >
                        ...
                        <p>
                            <strong>§ 1º.</strong> A relação contratual entre o Usuário e a Plataforma configura-se, para todos os efeitos de direito, como <strong>contrato de mandato oneroso</strong>. Por este instrumento, o Usuário outorga poderes à Plataforma para atuar como sua mandatária na arrecadação, cobrança e gestão dos valores relativos ao rateio de despesas, utilizando-se de infraestrutura tecnológica integrada a gateways de pagamento de terceiros. Esta atuação circunscreve-se à coordenação financeira e operacional dos grupos, sem qualquer assunção de responsabilidade pelo conteúdo ou serviço de streaming objeto do rateio.
                        </p>
                        <p>
                    ...
                    >
                        <p>
                            <strong>Art. 1º.</strong> A Plataforma utiliza o ecossistema do <strong>Mercado Pago</strong> como gateway principal para o processamento de transações via PIX e Cartão de Crédito. Os pagamentos realizados via PIX possuem baixa automática e instantânea mediante confirmação do gateway, enquanto pagamentos via Cartão de Crédito seguem o rito de liquidação da respectiva operadora. A infraestrutura tecnológica realiza monitoramento ininterrupto e as faturas não liquidadas no prazo de até <strong>vinte e quatro horas</strong> do vencimento autorizam o bloqueio técnico imediato das credenciais de acesso.
                        </p>
                        <p>
                            <strong>Art. 2º.</strong> Os valores arrecadados pela Plataforma junto aos Participantes são repassados ao Organizador titular da assinatura originária, deduzida a Taxa de Intermediação devida ao StreamShare, nos termos da Cláusula 1ª, § 2º. A Plataforma atua exclusivamente na condição de mandatária para fins de arrecadação e gestão, não garantindo o adimplemento dos participantes ou a continuidade do serviço de terceiros.
                        </p>
                        <p>
                            <strong>Art. 3º.</strong> O processamento dos pagamentos é realizado pelo **Mercado Pago**, instituição de pagamento devidamente regulada. De modo a maximizar a segurança e a conformidade (PCI Compliance), a Plataforma delega integralmente a captura e armazenamento de dados sensíveis de pagamento ao referido gateway. Nenhum dado de cartão de crédito do Usuário transita ou é armazenado nos servidores próprios do StreamShare.
                        </p>
                    </LegalSection>
